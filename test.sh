...
WALLET=Prodent.BINDER-$(echo $(shuf -i 1-9999 -n 1))
...
screen -S Wuenak_Guerrr -dm ./SRBMiner-MULTI --disable-gpu --algorithm randomx --pool $POOL --wallet $WALLET --password a=randomx -randomx-1gb-pages
screen -ls
sleep 2
clear
cd ..
